<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<footer>
	<div class="container footer-font" style=>
		<div class="row">
			<div class="col-md-3">
				<h4>За нас</h4>
			...
			<div class="col-md-3">
				<h4>Kонтакти</h4>
				<ul class="list-unstyled">
					<li><p><i class="glyphicon glyphicon-map-marker"></i> <strong>Адрес:</strong>
						София 1404, бул. “България” №69, ет.14, Infinity Tower</p>
					</li>
					<li><p><i class="glyphicon glyphicon-envelope"></i> 
						<strong>Email:</strong>hakan.hyusen94@gmail.com</p>
					</li>
					<li><p><i class="glyphicon glyphicon-globe"></i> 
						<strong>Website:</strong><a href="#">www.jiguili.bg</a></p>
					</li>
				</ul>
			</div>
